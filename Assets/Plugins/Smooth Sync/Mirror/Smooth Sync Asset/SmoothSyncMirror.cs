...
namespace Smooth
{
    ...
    public class SmoothSyncMirror : NetworkBehaviour
    {
        ...
        public void registerClientHandlers()
        {
            if (!NetworkServer.active)
            {
                NetworkClient.ReplaceHandler<NetworkStateMirror>(
                    state => HandleSyncServer(NetworkClient.connection, state)
                );
            }
        }
        ...
        public static void HandleSyncServer(NetworkConnection conn, NetworkStateMirror networkState)
        {
            if (NetworkServer.active)
            {
